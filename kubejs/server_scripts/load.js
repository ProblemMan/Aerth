onEvent('player.logged_in', event => {
    if (event.player.stages.has('spawned')) {
        ...
        console.log('boooped')
        //Item.of('minecraft:structure_block', {metadata:"",mirror:"NONE",ignoreEntities:1b,powered:0b,seed:0L,author:"ChiefArug",rotation:"CLOCKWISE_180",posX:0,mode:"LOAD",posY:1,sizeX:12,posZ:0,integrity:1.0f,showair:0b,name:"packname:start_crash",id:"minecraft:structure_block",sizeY:10,sizeZ:12,showboundingbox:1b})
        event.server.runCommandSilent(`setblock ${pos.x} ${pos.y} ${pos.z} minecraft:structure_block{metadata:"",mirror:"NONE",ignoreEntities:1b,powered:0b,seed:0L,author:"ChiefArug",rotation:"CLOCKWISE_180",posX:0,mode:"LOAD",posY:1,sizeX:12,posZ:0,integrity:1.0f,showair:0b,name:"packname:start_crash",id:"minecraft:structure_block",sizeY:10,sizeZ:12,showboundingbox:0b}`)
